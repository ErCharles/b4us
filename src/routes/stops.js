    ...
    if (rawTimes) {
        ...
        for (const t of times) {
            ...
            arrivals.push({
                ...
                realtime,
                color: lineColor(t.line?.shortDescription, t.line?.codLine),
...
// Official Madrid transport line colours (mirrors the frontend palette in
// public/app.js). Metro / Metro Ligero / Cercanías have official per-line hex;
// EMT / interurbano / urbano use their corporate mode colour; night → dark.
...
// Mode comes from codLine (4 Metro, 5 Cercanías, 6 EMT, 8 interurbano, 9 urbano, 10 ML).
